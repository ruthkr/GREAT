...
1. [Input requirements](https://ruthkr.github.io/greatR/articles/prepare-data.html)
...
4. [Register data with parameter optimisation](https://ruthkr.github.io/greatR/articles/optimise-parameters.html)
