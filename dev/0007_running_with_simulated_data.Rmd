...
### Data with 5 timepoints

```{r, warning=FALSE, fig.width=10, fig.height=10}
simulated_data_with_num_point_5 <- results_list[[2]]

simulated_data_with_num_point_5 %>% 
  ggplot() +
  aes(x = timepoint, y = mean_cpm, color = accession) +
  geom_line() +
  geom_point() +
...
```{r warning = FALSE, include=FALSE}
result_with_num_point_5 <- GREAT::scale_and_register_data(
  simulated_data_with_num_point_5,
  simulated_data_with_num_point_5,
  stretches = c(1, 2, 3, 4, 5, 6),
  shift_extreme = 6,
...
```{r}
result_with_num_point_5[["model_comparison_dt"]]
```



```{r, warning=FALSE, fig.width=10, fig.height=10}
GREAT::plot_registered_GoIs_for_comparible_timepoints(result_with_num_point_5[["imputed_mean_df"]])
```




### Data with 4 timepoints

```{r, warning=FALSE, fig.width=10, fig.height=10}
simulated_data_with_num_point_4 <- results_list[[1]]

simulated_data_with_num_point_4 %>% 
  ggplot() +
  aes(x = timepoint, y = mean_cpm, color = accession) +
  geom_line() +
  geom_point() +
...
```{r warning = FALSE, include=FALSE}
result_with_num_point_4 <- GREAT::scale_and_register_data(
  simulated_data_with_num_point_4,
  simulated_data_with_num_point_4,
  stretches = c(1, 2, 3, 4, 5, 6),
  shift_extreme = 6,
...
```{r, warning=FALSE, fig.width=10, fig.height=10}
GREAT::plot_registered_GoIs_for_comparible_timepoints(result_with_num_point_4[["imputed_mean_df"]])
```
