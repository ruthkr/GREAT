...
```{r BRAA06G025360.3C_16, echo=FALSE, fig.cap="BRAA06G025360.3C with max shifted time = 16", out.width = '45%'}
knitr::include_graphics("0010_case_real_data_with6_timepoints_files/figure-ext/BRAA06G025360.3C_16_mean.png")
```

```{r BRAA06G025360.3C_16_mixed, echo=FALSE, fig.cap="BRAA06G0253 60.3C with max shifted time = 16", out.width = '45%'}
