...
- Null hypothesis ($H_{0}$): $\mu_{\sigma_i, \forall n} = \mu_{\sigma_i, n = 6} = \dots = \mu_{\sigma_i,n = 4}$.
...
The p-value is far below 0.05, so the null is rejected, and it can be concluded there are differences between number of registered genes between different time point groups with SD = 0.35.
