---
title: "Using GREAT to align human and mouse fetal retina transcriptomic data"
output:
  github_document:
    toc: true
---
...
```{r fig.width=10, fig.height=50, warning=FALSE}
...
Before registering data, we can use function get_approximate_stretch() to help us finding the approximation of strect factor.
...
```{r include=FALSE}
registration_results <- readRDS("registration_results_human_fetal_retina.rds")
```
