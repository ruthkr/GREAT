...
mean.df <- new_mean_data[[1]] # will compare Col0 vs Ro18 based on accession column
...
test$delta.time[test$accession=='Col0'] <- test$delta.time[test$accession=='Col0'] * 4
...
```{r}
neg.extreme.candidates
```

```{r}
pos.extreme.candidates
```
...
neg.extreme <- max(pos.extreme.candidates[num.overlapping.points >= min.num.overlapping.points])
neg.extreme
```
