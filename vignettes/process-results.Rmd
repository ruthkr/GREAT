...
- `registered_genes` is a vector of gene accessions or IDs which were successfully registered.
...
The list of gene accessions which were registered or non-registered can be viewed by calling:
