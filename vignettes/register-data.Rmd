...
Note that the data has all of six columns required by the package as documented on the [preparing data](https://ruthkr.github.io/GREAT/articles/prepare_data.html) article.
...
These data frame outputs can further be summarised and visualised; see the documentation on the [visualising results](https://ruthkr.github.io/GREAT/articles/visualise-results.html) article.
