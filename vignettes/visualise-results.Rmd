...
After running registration function `scale_and_register_data()` as shown in [ruthkr.github.io/GREAT/articles/register-data.html](https://ruthkr.github.io/GREAT/articles/register-data.html), users can get summary and visualise the results as illustrated in the figure below.
