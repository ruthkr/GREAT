...
After running registration function `scale_and_register_data()` as shown in the [registering data](https://ruthkr.github.io/GREAT/articles/register-data.html) article, users can summarise and visualise the results as illustrated in the figure below.
