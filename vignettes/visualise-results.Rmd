...
The total number of registered and non-registered genes can be obtained by running function `summary_registration()` with `registration_results` object as an input.
